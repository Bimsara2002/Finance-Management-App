...
def get_oracle_connection():
    ...
    return oracledb.connect(
        user="system",   # ✅ use your Oracle username
        password="82322929",   # ⚠️ use your actual Oracle password
...
def init_sqlite():
    try:
        ...
        conn.commit()
        conn.close()
        print("✅ SQLite 'register' table ready.")
    except Exception as e:
        print("⚠️ SQLite setup error:", e)
...
def register_user():
    try:
        ...
        conn.commit()
        conn.close()
        print(f"✅ Added user '{username}' to SQLite.")
        ...
        try:
            ...
            # Ensure Oracle table exists
            oracle_cur.execute("""
                BEGIN
                    EXECUTE IMMEDIATE 'CREATE TABLE register (
            ...
            encoded_pw = base64.b64encode(hashed_pw).decode("utf-8")
            oracle_cur.execute("""
                INSERT INTO register (username, email, password)
                VALUES (:username, :email, :password)
            """, {"username": username, "email": email, "password": encoded_pw})

            oracle_conn.commit()
            oracle_cur.close()
            oracle_conn.close()
            print(f"✅ User '{username}' also saved to Oracle.")
        except Exception as e:
            print("⚠️ Oracle insert failed:", e)
            traceback.print_exc()

        return jsonify({"message": "✅ Registration successful (saved in both DBs)!"}), 201

    except Exception as e:
        print("❌ Error in registration route:")
        traceback.print_exc()
...
def login_user():
    try:
        ...
        try:
            ...
            print("⚠️ Oracle login check failed:", e)
...
def add_income():
    try:
        ...
        try:
            ...
            print("⚠️ Oracle income insert failed:", e)
...
def view_income(user_id):
    try:
        ...
        try:
            ...
            print("⚠️ Oracle fetch income failed:", e)
...
def update_income(income_id):
    try:
        ...
        try:
            ...
            # Try updating first — if no rows affected, then insert
            oracle_cur.execute("""
                UPDATE monthly_income
            ...
            print("⚠️ Oracle update failed:", e)

        return jsonify({"message": "✅ Income updated successfully in both databases!"})
...
def delete_income(income_id):
    try:
        ...
        try:
            ...
            print("⚠️ Oracle delete failed:", e)
...
def delete_saving(saving_id):
    try:
        ...
        return jsonify({"message": "✅ Saving deleted from both databases!"})
...
def view_expenses(user_id):
    try:
        ...
        try:
            ...
            print("⚠️ Oracle fetch expenses failed:", e)
    ...
    try:
        ...
        if user_id is None or month == "" or category == "" \
           or amount in [None, ""] or date_spent == "" or payment_method == "":
            return jsonify({"message": "⚠️ Please fill all required fields"}), 400

        try:
            amount = float(amount)
        except:
            return jsonify({"message": "⚠️ Amount must be a number"}), 400
        ...
        return jsonify({"message": f"✅ {msg} successfully in both databases!"})
...
def delete_expense(expense_id):
    try:
        ...
        try:
            ...
            if not row:
                return jsonify({"message": "⚠️ Expense not found"}), 404
        ...
        return jsonify({"message": "✅ Expense deleted successfully from both databases!"})
...
def save_budget(budget_id=None):
    try:
        ...
        try:
            ...
            return jsonify({"message": "⚠ Amounts must be numbers"}), 400
...
def view_budget(user_id):
    try:
        ...
        try:
            ...
            print("⚠ Oracle fetch budget failed:", e)
...
def delete_budget(budget_id):
    try:
        ...
        try:
            ...
            print("⚠ Oracle delete failed:", e)

        return jsonify({"message": "✅ Budget deleted successfully from both databases!"})
...
def save_financial_goal(goal_id=None):
    try:
        ...
        try:
            ...
            return jsonify({"message": "⚠ Amounts must be numeric"}), 400
        ...
        print("❌ Error saving financial goal:", e)
        return jsonify({"message": "Server error", "error": str(e)}), 500
...
def view_goals(user_id):
    try:
        ...
        try:
            ...
            print("⚠ Oracle fetch goals failed:", e)
...
def delete_financial_goal(goal_id):
    try:
        ...
        return jsonify({"message": "✅ Financial goal deleted successfully from both databases!"})
...
def backup_data():
    try:
        # ✅ Connect to Oracle using your existing function
        conn = get_oracle_connection()
        cursor = conn.cursor()

        # ✅ Call your PL/SQL backup procedure
